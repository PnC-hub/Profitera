      ...
      <nav class="fixed top-0 w-full bg-white/90 backdrop-blur-md border-b border-slate-200 z-50">
        <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            <a href="#funzionalita" class="text-slate-600 hover:text-slate-800 text-sm font-medium hidden md:inline">Funzionalita</a>
        ...
        <div class="max-w-6xl mx-auto px-6">
          <div class="max-w-3xl mx-auto text-center">
            <div class="inline-flex items-center gap-2 bg-cyan-50 text-cyan-700 px-4 py-2 rounded-full text-sm font-semibold mb-6">
              ...
              Modulo per Studi Dentistici
            </div>
            <h1 class="text-4xl md:text-5xl font-extrabold text-slate-900 leading-tight mb-6">
              Il controllo di gestione
              <span class="bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">automatizzato</span>
              per il tuo studio
            </h1>
            <p class="text-xl text-slate-500 mb-8 leading-relaxed">
              Contabilita, finanza e analisi dei costi in un unico modulo.
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#pricing" class="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-2xl font-bold text-lg hover:shadow-xl hover:shadow-cyan-500/25 transition-all hover:-translate-y-0.5">
                Scopri i Piani <i class="fas fa-arrow-right ml-2"></i>
              </a>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 max-w-4xl mx-auto">
            ...
            <div class="text-center">
              <p class="text-3xl font-extrabold text-slate-800">Real-time</p>
              <p class="text-sm text-slate-500 mt-1">Dati finanziari</p>
            </div>
            <div class="text-center">
              <p class="text-3xl font-extrabold text-slate-800">Multi</p>
              <p class="text-sm text-slate-500 mt-1">Azienda / Centro</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-20 bg-white">
        <div class="max-w-6xl mx-auto px-6">
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="p-6 rounded-2xl border border-red-100 bg-red-50/50">
              ...
              <p class="text-slate-500">L'amministrativa passa ore a riconciliare movimenti bancari con fatture, copiando dati tra fogli diversi.</p>
            </div>
            <div class="p-6 rounded-2xl border border-amber-100 bg-amber-50/50">
              <div class="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center mb-4">
                <i class="fas fa-eye-slash text-amber-500 text-xl"></i>
              </div>
              <h3 class="font-bold text-slate-800 text-lg mb-2">Zero visibilita sui costi</h3>
              <p class="text-slate-500">Non sai quanto costa realmente ogni prestazione. Il BEP dello studio resta un mistero fino al bilancio annuale.</p>
            </div>
            <div class="p-6 rounded-2xl border border-orange-100 bg-orange-50/50">
              ...
              <p class="text-slate-500">Produzione clinica e contabilita vivono in mondi separati. Nessuna integrazione automatica.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="funzionalita" class="py-20 bg-slate-50">
        <div class="max-w-6xl mx-auto px-6">
          <div class="text-center mb-16">
            <span class="text-cyan-600 font-bold text-sm uppercase tracking-wider">Funzionalita</span>
            <h2 class="text-3xl font-extrabold text-slate-900 mt-2 mb-4">Due moduli, un ecosistema</h2>
            <p class="text-lg text-slate-500">Tutto cio che serve per il controllo economico-finanziario</p>
          </div>
          ...
          <div class="mb-16">
            <div class="flex items-center gap-3 mb-8">
              ...
              <h3 class="text-2xl font-bold text-slate-800">Contabilita</h3>
            </div>
          ...
          <div class="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-10 md:p-16 text-center">
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              ...
              <div class="bg-white/10 rounded-2xl p-6 backdrop-blur">
                ...
                <p class="text-slate-400 text-sm mt-1">Gestisci piu studi da un unico pannello</p>
              </div>
              <div class="bg-white/10 rounded-2xl p-6 backdrop-blur">
      ...
      <section id="pricing" class="py-20 bg-slate-50">
        <div class="max-w-6xl mx-auto px-6">
          ...
          <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-2xl border-2 border-cyan-500 p-8 shadow-xl shadow-cyan-500/10 relative">
              ...
              <a href="mailto:info@geniusmile.com?subject=Richiesta Piano Professional CDG" class="block w-full py-3 text-center bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-bold hover:shadow-lg hover:shadow-cyan-500/25 transition-all">
                Richiedi Demo
              </a>
            </div>
        ...
        <div class="max-w-3xl mx-auto px-6">
          ...
          <div class="space-y-4">
            <div v-for="(faq, i) in faqs" :key="i" class="border border-slate-200 rounded-xl overflow-hidden">
              ...
              <div v-show="openFaq === i" class="px-6 pb-4 text-slate-500">
                {{ faq.a }}
              </div>
            </div>
          </div>
...
const faqs = [
  {
    ...
    a: 'Si, il modulo Controllo di Gestione si integra nativamente con Geniusmile CRM. I dati di produzione, fatturazione e incassi vengono sincronizzati automaticamente.'
  },
  {
  ...
  {
    q: 'Posso gestire piu studi da un unico account?',
    a: 'Si, con il piano Professional puoi gestire fino a 3 centri, con Enterprise centri illimitati. Basta un click per switchare tra le aziende.'
  },
  {
    q: 'E\' possibile provare il modulo prima di acquistare?',
